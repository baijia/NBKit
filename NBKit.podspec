#
#  Be sure to run `pod spec lint NBKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/baijia/NBKit.git", :tag => s.version }
  ...
  s.source_files  = "NBKit", "NBKit/**/*.{h,m}"
  # s.exclude_files = "NBKit/Exclude"

  s.public_header_files = "NBKit/**/*.h"
